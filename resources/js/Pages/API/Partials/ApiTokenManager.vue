...
<template>
    <div>
        ...
        <JetFormSection @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <JetInput
                        ...
                        autofocus
                    />
                    <JetInputError :message="createApiTokenForm.errors.name"
                        class="mt-2"
                    />
                </div>
            ...
            <template #actions>
                <JetActionMessage :on="createApiTokenForm.recentlySuccessful"
                    class="mr-3"
                >
                    Created.
                </JetActionMessage>
        ...
        <!-- Token Value Modal -->
        <JetDialogModal :show="displayingToken"
        ...
        <JetDialogModal :show="managingPermissionsFor != null"
        ...
        >
            ...
            <template #content>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                        <label class="flex items-center">
                            <JetCheckbox v-model:checked="updateApiTokenForm.permissions"
                                :value="permission"
                            />
                            <span class="ml-2 text-sm text-gray-600">{{ permission }}</span>
                        </label>
        ...
        <JetConfirmationModal :show="apiTokenBeingDeleted != null"
